...
def main():
    ...
    page = st.sidebar.radio("Navigation", ["Home", "Attacks Info Page" ])
    ...
    elif page == "Attacks Info Page":
        st.markdown("<h2 style='text-align: center;'>SQL Injection</h2>", unsafe_allow_html=True)
        st.write("SQL injection is a type of attack where an attacker exploits vulnerabilities in a web application's database layer by injecting malicious SQL code, potentially leading to unauthorized access, data manipulation, or other malicious actions.")
        st.write("The different types of attack that we used in the tool are mentioned below:")
